export const MESSAGES = {
  ...
  DOCUMENTS: {
    ...
    CATEGORY_KANUN: 'Kanun',
    CATEGORY_MULGA: 'Mülga',
    CATEGORY_KARAR: 'Karar',
    CATEGORY_KARARNAME: 'Kararname',
    CATEGORY_TUZUK: 'Tüzük',
    CATEGORY_YONERGE: 'Yönerge',
    CATEGORY_TALIMAT: 'Talimat',
    CATEGORY_SIRKULER: 'Sirküler',
    CATEGORY_EMIR: 'Emir',
    CATEGORY_TEBLIGNAME: 'Tebliğname',
    CATEGORY_MAHKEME: 'Mahkeme Kararı',
    CATEGORY_ANAYASA: 'Anayasa',
    CATEGORY_ANAYASA_MAHKEMESI: 'Anayasa Mahkemesi',
    CATEGORY_DANISTAY: 'Danıştay',
    CATEGORY_SAYISTAY: 'Sayıştay',
    CATEGORY_ULUSLARARASI: 'Uluslararası',
    CATEGORY_AVRUPA_BIRLIGI: 'Avrupa Birliği',
    CATEGORY_MEVZUAT_DUZENLEMESI: 'Mevzuat Düzenlemesi',
    CATEGORY_CUMHURBASKANLIGI_KARARNAMESI: 'Cumhurbaşkanlığı Kararnamesi',
    CATEGORY_YARGITAY_KARARI: 'Yargıtay Kararı',
    CATEGORY_RAPOR: 'Rapor',
    CATEGORY_TUTANAK: 'Tutanak',
    CATEGORY_ANTLASMA: 'Antlaşma',
    CATEGORY_SOZLESME: 'Sözleşme',
    CATEGORY_AB_DIREKTIFI: 'AB Direktifi',
    CATEGORY_AB_TUZUGU: 'AB Tüzüğü',
    CATEGORY_ULUSLARARASI_KARAR: 'Uluslararası Karar',
